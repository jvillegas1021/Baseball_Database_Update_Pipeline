...
def process_starting_pitcher_current_year_stats(pitcher_statsapi_df, pitcher_statcast_df):
    ...
    current_year_stats_df['K/9'] = current_year_stats_df['strikeOuts'] / current_year_stats_df['inningsPitched']
    ...
    current_year_stats_df["Hard%"] = current_year_stats_df["hard_hit_balls"] / current_year_stats_df["batted_balls"]
    ...
    final_columns = [
        ...
        # Workload
        "gamesStarted", "inningsPitched", "battersFaced",
        
        # Results
        "wins", "losses", "ERA", "xERA", "FIP", "AVG", "WHIP", "BABIP", "RS/9", "HR/9", "LOB%",
        
        # K/BB profile
        "K%", "BB%", "K/BB", "K-BB%", "K/9",
        
        # Contact quality
        "EV", "LA", "Hard%", "Barrel%", "GB%", "FB%", "LD%", "HR/FB",
