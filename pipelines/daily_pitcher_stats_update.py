...
from data_transform_functions.process_functions import process_starting_pitcher_stats
...
def run_daily_pitcher_stats_update():
    ...
    #transform
    pitcher_current_year_stats_df = process_starting_pitcher_stats(pitcher_statsapi, pitcher_statcast)
    #load
